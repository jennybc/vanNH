...
suppressWarnings(sDat$pl_lname <-
                   I(with(sDat,
                          ifelse(pl_team == away_team,
                                 away_roster$last[match(as.numeric(sDat$pl_pnum),
                                                        away_roster$number)],
                                 home_roster$last[match(as.numeric(sDat$pl_pnum),
                                                        home_roster$number)]))))
