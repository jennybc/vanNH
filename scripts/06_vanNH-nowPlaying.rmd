...
vanNH_roster_file <- file.path("..", "rosters", "2014_vanNH-roster.tsv")
opp_roster_file   <- file.path("..", "rosters", "2014_pdxST-roster.tsv")
game_file         <- file.path("..", "games", "2014-04-12_vanNH-at-pdxST",
                               "cleanGoogleExtract",
                               "2014-04-12_vanNH-at-pdxST_gameplay-clean.tsv")

sDat <- read.delim(game_file)
vRoster <- read.delim(vanNH_roster_file, stringsAsFactors = FALSE)
oRoster <- read.delim(opp_roster_file, stringsAsFactors = FALSE)
