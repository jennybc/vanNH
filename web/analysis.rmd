...
Dataset: all possessions from all games involving Vancouver Nighthawks in 2014 through week 09
...
Here we just confirm the ranking in the Western Conference:
  ...
  * pdxST (over 50% of possessions end in a goal) > vanNH (46%) > seaRM (43%) >> sfoDF (24%)
...
To be clear here, within a team * line combination, the bar heights add up to 1. So we get the breakdown of how possessions end when, e.g. a Portland Stags' `o_line` had the disc: 55% end in a goal for them, 24% end in a turnover nominally due to offense error, and 17% end with an explicit stop by the defense.
...
Dataset: all points played from all games involving Vancouver Nighthawks in 2014 through week 09 (n = 394 points)
