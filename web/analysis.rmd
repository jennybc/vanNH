...
Possessions leading to goals last longer than those leading turnovers. I guess that's to be expected. And still, regardless of the outcome, the Stags' possessions are the longest.
